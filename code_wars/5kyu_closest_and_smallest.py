# Problem: Closest and Smallest (5kyu)
"""
Input
...
If n == 0, `closest("") should return [] or ([], []) in Haskell, Clojure,
...
def closest(strng):
	...
	strng_weight = [[sum( int(digit) for digit in list(number)), index, int(number) ]for index, number in enumerate(strng.split())]
	# closest = [value[0] for idx, value in enumerate(strng_weight)]

	return sorted(strng_weight, key=lambda x: x[0])
	# return sorted(strng_weight)
	# return list(filter(lambda x:x[0],strng_weight))
	# return strng_weight


# s = "444 2000 445 644 2001 1002" # should return [[3, 4, 2001], [3, 5, 1002]]
# s = "54 239382 162 254765 182 485944 468751 49780 108" # should return [[9, 0, 54], [9, 2, 162]]
# s = "239382 162 254765 182 485944 468751 49780 108 54" # should return [[9, 1, 162], [9, 7, 108]]
# s = "444 2000 445 544" # should return [[13, 2, 445], [13, 3, 544]]
# s = "80 71 62 53" # should return [[8, 0, 80], [8, 1, 71]]
s = "103 123 4444 99 2000" # should return [[2, 4, 2000], [4, 0, 103]]
